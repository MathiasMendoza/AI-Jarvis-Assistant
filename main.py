...
def run_jarvis():
    ...
    ##############
        ...
        if workspace:
            ...
            # Visual Studio Code
            elif 'vs code' in workspace or 'visual studio code' in command or 'visual studio' in command:
                print("Playing what you like for work sir")
                talk("Playing what you like for work sir")
                url = 'https://www.youtube.com/watch?v=pAgnJDJN4VA&list=PLO4j69SgfbvgA8g-NMAFWj0bmfXQHV70d'
                chrome_path = 'C:/Program Files (x86)/Google/Chrome/Application/chrome.exe %s'
    ...
    #####################
        ...
        if note:
            ...
            answer = take_command()
            if 'new' in answer:
                print("What we could the new file sir?")
                talk("What we could the new file sir?")
